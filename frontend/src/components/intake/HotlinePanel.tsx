  ...
  const handleTranscribe = async () => {
    ...
    try {
      ...
      const res = await axios.post(
        "http://localhost:3000/api/hotline/transcribe-audio",
        formData,
        {
    ...
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="bg-red-500/10 border border-red-500/20 p-3 rounded-lg flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-xs font-bold text-red-100 uppercase tracking-wide">
              Line Active
            </h3>
        ...
        <div className="space-y-2">
          <label className="text-xs text-gray-400 font-semibold flex items-center justify-between">
            <span className="flex items-center gap-1">
              <Edit3 size={12} /> Call Logs / Transcript / Audio
            </span>
            ...
            <div className="flex items-center gap-2">
              {audioFile ? (
                <div className="flex items-center gap-2 bg-gray-800 px-2 py-1 rounded border border-gray-700">
                  <span className="text-[10px] text-green-400 max-w-[100px] truncate">
                    {audioFile.name}
                  </span>
                  <button
                ...
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className={`text-[10px] flex items-center gap-1 px-2 py-1 rounded border transition-all ${
                      isRecording
        ...
        <div className="flex gap-2">
          ...
          >
            {loading ? (
              ...
              <>
                <Send size={14} /> Create Incident Report
              </>
            )}
          </button>
        </div>
